...
bool TinyGPSPlus::encode(char c)
{
  ...
  switch(c)
  {
    case ',': // term terminators
      parity ^= (uint8_t)c;
      [[fallthrough]]; // Intentional fallthrough to next case
    case '\r':
    case '\n':
    case '*':
      {
...
// ####################################################
// TinyGPSLocation struct functions:
...
// ##########################################################################
// TinyGPSDecimal struct functions:
...
// ##########################################################################
// TinyGPSInteger struct functions:
