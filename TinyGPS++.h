...
/*
TinyGPS++ - a small GPS library for General Linux/Windows c++ programs providing universal NMEA parsing
Based on work by and "distanceBetween" and "courseTo" courtesy of Maarten Lamers.
Suggestion to add satellites, courseTo(), and cardinal() by Matt Monson.
Location precision improvements suggested by Wayne Holder.
This library forked from https://github.com/mikalhart/TinyGPSPlus that it is for Arduino boards. 
Mohammad nikanjam adapt library for General Linux/Windows c++ programs.
